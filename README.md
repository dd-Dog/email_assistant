...
7. **📁 项目知识库** ⭐ V5.1 NEW - 从文件夹加载项目文档（TXT/MD）
8. **🏷️ 关键词智能标记** ⭐ V5.1 NEW - 通用+项目关键词自动识别
9. **📊 产品参数管理** ⭐ V5.1 NEW - 结构化产品参数系统
...
详见 [ROADMAP.md](ROADMAP.md) | [V5.1_README.md](V5.1_README.md) | [V5_USAGE.md](V5_USAGE.md)

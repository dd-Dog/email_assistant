...
2. **五类人员分类** - 领导/项目经理/员工/客户/供应商
3. **🤖 AI智能分析** - OpenAI/Gemini智能摘要和优先级识别
4. **🎯 上下文感知** - 基于人员背景和项目信息的精准分析
5. **客户需求深度分析** - 可行性+实现方法+建议（基于背景）
6. **项目自动关联** - 识别邮件中的项目并显示项目信息
7. **📁 项目知识库** - 从文件夹加载项目文档（TXT/MD/DOCX/XLSX）
8. **🏷️ 关键词智能标记** - 通用+项目关键词自动识别
9. **📊 产品参数管理** - 结构化产品参数系统
10. **📋 Excel人员管理** - 批量管理，告别JSON手动维护
11. **👥 组织关系网络** ⭐ V5.3 NEW - 层级关系、责任链、PM-客户映射
12. **🎯 自动责任追溯** ⭐ V5.3 NEW - 自动识别项目责任人和升级路径
7. **智能内容清理** - 自动去除邮件签名、联系方式等无关信息
8. **按天汇总展示** - 每个人的邮件按天分组，清晰的时间线视图
9. **智能重复问题检测** - 检测连续3天未解决的问题，重点标注
10. **本地报告保存** - 自动保存到reports/目录，永不丢失
11. **定时任务** - 每天自动运行，无需人工干预
12. **多邮箱发送** - 支持多个收件邮箱
...
| `days_to_check` | 检查最近几天的邮件 | 3 (V3.0优化) |
...
2. **🚨 连续3天未解决的问题** - 自动检测并重点标注（最优先显示）
3. **👔 领导邮件汇总** - 按人员 → 按天分组，清晰时间线
4. **👥 员工邮件汇总** - 按人员 → 按天分组，排除重复问题

### V3.0新特性

- ✨ **内容自动清理** - 去除签名、联系方式等，只看正文
- ✨ **按天汇总** - 例如"张三：第1天内容、第2天内容、第3天内容"
- ✨ **更快速度** - 只检查最近3天，处理速度提升60%
- ✨ **时间线视图** - 每天的邮件按时间排序，一目了然
...
- **V5.3** (2025-11-13) - 👥 组织关系管理（当前版本）✨
- **V5.2** (2025-11-13) - 📋 人员信息文件化
- **V5.1** (2025-11-13) - 📚 项目知识库
- **V5.0** (2025-11-12) - 🎯 上下文感知AI
- **V4.0** (2025-11-11) - 🤖 AI智能分析
- **V3.0** (2025-11-11) - 内容清理、按天汇总、性能优化
- **V2.0** (2025-11-11) - 分类配置、按人分组、姓名显示优化
- **V1.0** (2025-11-11) - 初始版本

详见 [V5.3_README.md](V5.3_README.md) | [V5.2_README.md](V5.2_README.md) | [V5.1_README.md](V5.1_README.md)
